...
{
public:
    libbitcoinlove::SproutPaymentAddress address;
    /**
    ...
    SproutNoteData(libbitcoinlove::SproutPaymentAddress a) :
            address {a}, nullifier(), witnessHeight {-1} { }
    SproutNoteData(libbitcoinlove::SproutPaymentAddress a, uint256 n) :
...
public:
    ...
    SaplingNoteData(libbitcoinlove::SaplingIncomingViewingKey ivk) : ivk {ivk}, witnessHeight {-1}, nullifier() { }
    SaplingNoteData(libbitcoinlove::SaplingIncomingViewingKey ivk, uint256 n) : ivk {ivk}, witnessHeight {-1}, nullifier(n) { }
...
struct SproutNoteEntry
{
    JSOutPoint jsop;
    libbitcoinlove::SproutPaymentAddress address;
    libbitcoinlove::SproutNote note;
...
{
    SaplingOutPoint op;
    libbitcoinlove::SaplingPaymentAddress address;
...
public:
    ...
    std::map<libbitcoinlove::SproutPaymentAddress, CKeyMetadata> mapSproutZKeyMetadata;
    std::map<libbitcoinlove::SaplingIncomingViewingKey, CKeyMetadata> mapSaplingZKeyMetadata;
    ...
    libbitcoinlove::SproutPaymentAddress GenerateNewSproutZKey();
    //! Adds spending key to the store, and saves it to disk
    bool AddSproutZKey(const libbitcoinlove::SproutSpendingKey &key);
    //! Adds spending key to the store, without saving it to disk (used by LoadWallet)
    bool LoadZKey(const libbitcoinlove::SproutSpendingKey &key);
    //! Load spending key metadata (used by LoadWallet)
    bool LoadZKeyMetadata(const libbitcoinlove::SproutPaymentAddress &addr, const CKeyMetadata &meta);
    //! Adds an encrypted spending key to the store, without saving it to disk (used by LoadWallet)
    bool LoadCryptedZKey(const libbitcoinlove::SproutPaymentAddress &addr, const libbitcoinlove::ReceivingKey &rk, const std::vector<unsigned char> &vchCryptedSecret);
    ...
    bool AddSproutViewingKey(const libbitcoinlove::SproutViewingKey &vk);
    bool RemoveSproutViewingKey(const libbitcoinlove::SproutViewingKey &vk);
    //! Adds a Sprout viewing key to the store, without saving it to disk (used by LoadWallet)
    bool LoadSproutViewingKey(const libbitcoinlove::SproutViewingKey &dest);

    /**
      * Sapling ZKeys
      */
    //! Generates new Sapling key
    libbitcoinlove::SaplingPaymentAddress GenerateNewSaplingZKey();
    //! Adds Sapling spending key to the store, and saves it to disk
    bool AddSaplingZKey(
        const libbitcoinlove::SaplingExtendedSpendingKey &key,
    ...
    bool AddCryptedSaplingSpendingKey(
        ...
        const libbitcoinlove::SaplingPaymentAddress &defaultAddr);
    //! Adds spending key to the store, without saving it to disk (used by LoadWallet)
    bool LoadSaplingZKey(const libbitcoinlove::SaplingExtendedSpendingKey &key);
    //! Load spending key metadata (used by LoadWallet)
    bool LoadSaplingZKeyMetadata(const libbitcoinlove::SaplingIncomingViewingKey &ivk, const CKeyMetadata &meta);
    ...
    bool LoadSaplingPaymentAddress(
        ...
        const libbitcoinlove::SaplingIncomingViewingKey &ivk);
    //! Adds an encrypted spending key to the store, without saving it to disk (used by LoadWallet)
    bool LoadCryptedSaplingZKey(const libbitcoinlove::SaplingExtendedFullViewingKey &extfvk,
                                const std::vector<unsigned char> &vchCryptedSecret);
    ...
    std::set<std::pair<libbitcoinlove::PaymentAddress, uint256>> GetNullifiersForAddresses(const std::set<libbitcoinlove::PaymentAddress> & addresses);
    bool IsNoteSproutChange(const std::set<std::pair<libbitcoinlove::PaymentAddress, uint256>> & nullifierSet, const libbitcoinlove::PaymentAddress & address, const JSOutPoint & entry);
    bool IsNoteSaplingChange(const std::set<std::pair<libbitcoinlove::PaymentAddress, uint256>> & nullifierSet, const libbitcoinlove::PaymentAddress & address, const SaplingOutPoint & entry);
    ...
    /** Zelnode Additions */
    /// Get 10000, 25000, 100000, BLV output and keys which can be used for the Zelnode
...
public:
    ...
    bool operator()(const libbitcoinlove::SproutPaymentAddress &zaddr) const;
    bool operator()(const libbitcoinlove::SaplingPaymentAddress &zaddr) const;
    bool operator()(const libbitcoinlove::InvalidEncoding& no) const;
};
...
class GetSpendingKeyForPaymentAddress : public boost::static_visitor<boost::optional<libbitcoinlove::SpendingKey>>
{
private:
    CWallet *m_wallet;
public:
    ...
    boost::optional<libbitcoinlove::SpendingKey> operator()(const libbitcoinlove::SproutPaymentAddress &zaddr) const;
    boost::optional<libbitcoinlove::SpendingKey> operator()(const libbitcoinlove::SaplingPaymentAddress &zaddr) const;
    boost::optional<libbitcoinlove::SpendingKey> operator()(const libbitcoinlove::InvalidEncoding& no) const;
};
...
public:
    ...
    SpendingKeyAddResult operator()(const libbitcoinlove::SproutSpendingKey &sk) const;
    SpendingKeyAddResult operator()(const libbitcoinlove::SaplingExtendedSpendingKey &sk) const;
    SpendingKeyAddResult operator()(const libbitcoinlove::InvalidEncoding& no) const;
};
