...
#ifndef BLVCASHNODES_BLVNODEMAN_H
#define BLVCASHNODES_BLVNODEMAN_H
...
#define BLVNODES_DUMP_SECONDS (15 * 60)
#define BLVNODES_DSEG_SECONDS (3 * 60 * 60)
...
#endif //BLVCASHNODES_BLVNODEMAN_H
