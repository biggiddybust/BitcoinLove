...
#ifndef BLVCASHNODES_BLVNODE_H
#define BLVCASHNODES_BLVNODE_H
...
#define BLVNODE_MIN_CONFIRMATIONS 15 // Zelnode collateral minimum confirmations
#define BLVNODE_MIN_ZNP_SECONDS (10 * 60) // Zelnode minimum ping time
#define BLVNODE_MIN_ZNB_SECONDS (5 * 60) // Zelnode minimum broadcast time
#define BLVNODE_PING_SECONDS (5 * 60)
#define BLVNODE_EXPIRATION_SECONDS (120 * 60)
#define BLVNODE_REMOVAL_SECONDS (130 * 60)
#define BLVNODE_CHECK_SECONDS 5

#define BLVNODE_BASIC_COLLATERAL 10000
#define BLVNODE_SUPER_COLLATERAL 25000
#define BLVNODE_BAMF_COLLATERAL 100000
...
public:
    ...
    bool IsEnabled()
    {
        return activeState == BLVNODE_ENABLED;
    }
    ...
    std::string Status()
    {
        ...
        if (activeState == Zelnode::BLVNODE_ENABLED) strStatus = "ENABLED";
        if (activeState == Zelnode::BLVNODE_PRE_ENABLED) strStatus = "PRE_ENABLED";
        if (activeState == Zelnode::BLVNODE_EXPIRED) strStatus = "EXPIRED";
        if (activeState == Zelnode::BLVNODE_VIN_SPENT) strStatus = "VIN_SPENT";
        if (activeState == Zelnode::BLVNODE_REMOVE) strStatus = "REMOVE";
