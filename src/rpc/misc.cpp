...
{
public:
    UniValue operator()(const libbitcoinlove::InvalidEncoding &zaddr) const { return UniValue(UniValue::VOBJ); }

    UniValue operator()(const libbitcoinlove::SproutPaymentAddress &zaddr) const {
        UniValue obj(UniValue::VOBJ);
    ...
    UniValue operator()(const libbitcoinlove::SaplingPaymentAddress &zaddr) const {
        UniValue obj(UniValue::VOBJ);
