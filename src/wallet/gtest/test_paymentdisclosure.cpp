...
/*
    To run tests:
    ./bitcoinlove-gtest --gtest_filter="paymentdisclosure.*"
...
TEST(paymentdisclosure, mainnet) {
    ...
    for (int i=0; i<NUM_TRIES; i++) {
        ...
        info.zaddr = libbitcoinlove::SproutSpendingKey::random().address();
        ...
        info2.zaddr = libbitcoinlove::SproutSpendingKey::random().address();        
