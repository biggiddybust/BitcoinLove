...
router", implementing the bitcoinlove wire protocol and relay, making
...
The ZeroMQ feature in Bitcoinlove requires ZeroMQ API version 4.x or
...
For instance:
    ...
    $ bitcoinloved -zmqpubhashtx=tcp://127.0.0.1:28332 \
               -zmqpubrawtx=ipc:///tmp/bitcoinloved.tx.raw
...
From the perspective of bitcoinloved, the ZeroMQ socket is write-only; PUB
sockets don't even have a read function. Thus, there is no state
introduced into bitcoinloved directly. Furthermore, no information is
...
using. Bitcoinloved appends an up-counting sequence number to each
