...
bool CBasicKeyStore::AddSproutSpendingKey(const libbitcoinlove::SproutSpendingKey &sk)
{
    LOCK(cs_SpendingKeyStore);
...
bool CBasicKeyStore::AddSproutViewingKey(const libbitcoinlove::SproutViewingKey &vk)
...
bool CBasicKeyStore::RemoveSproutViewingKey(const libbitcoinlove::SproutViewingKey &vk)
{
    LOCK(cs_SpendingKeyStore);
...
bool CBasicKeyStore::HaveSproutViewingKey(const libbitcoinlove::SproutPaymentAddress &address) const
{
    LOCK(cs_SpendingKeyStore);
    return mapSproutViewingKeys.count(address) > 0;
}

bool CBasicKeyStore::HaveSaplingFullViewingKey(const libbitcoinlove::SaplingIncomingViewingKey &ivk) const
{
    LOCK(cs_SpendingKeyStore);
    return mapSaplingFullViewingKeys.count(ivk) > 0;
}

bool CBasicKeyStore::HaveSaplingIncomingViewingKey(const libbitcoinlove::SaplingPaymentAddress &addr) const
{
    LOCK(cs_SpendingKeyStore);
...
bool CBasicKeyStore::GetSaplingFullViewingKey(const libbitcoinlove::SaplingIncomingViewingKey &ivk,
...
bool CBasicKeyStore::GetSaplingIncomingViewingKey(const libbitcoinlove::SaplingPaymentAddress &addr,
...
bool CBasicKeyStore::GetSaplingExtendedSpendingKey(const libbitcoinlove::SaplingPaymentAddress &addr, 
