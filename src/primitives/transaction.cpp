...
{
    std::array<libbitcoinlove::SproutNote, ZC_NUM_JS_OUTPUTS> notes;
...
public:
    ...
    bool operator()(const libbitcoinlove::PHGRProof& proof) const
    {
    ...
    bool operator()(const libbitcoinlove::GrothProof& proof) const
    {
