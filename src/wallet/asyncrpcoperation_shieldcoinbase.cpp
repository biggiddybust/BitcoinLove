...
bool ShieldToAddress::operator()(const libbitcoinlove::SproutPaymentAddress &zaddr) const {
...
bool ShieldToAddress::operator()(const libbitcoinlove::SaplingPaymentAddress &zaddr) const {
...
bool ShieldToAddress::operator()(const libbitcoinlove::InvalidEncoding& no) const {
    return false;
}
