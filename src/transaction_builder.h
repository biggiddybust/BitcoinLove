...
private:
    ...
    std::vector<libbitcoinlove::JSInput> jsInputs;
    std::vector<libbitcoinlove::JSOutput> jsOutputs;
    std::vector<TransparentInputInfo> tIns;

    boost::optional<std::pair<uint256, libbitcoinlove::SaplingPaymentAddress>> saplingChangeAddr;
    boost::optional<libbitcoinlove::SproutPaymentAddress> sproutChangeAddr;
...
public:
    ...
    void SendChangeTo(libbitcoinlove::SaplingPaymentAddress changeAddr, uint256 ovk);

    void SendChangeTo(libbitcoinlove::SproutPaymentAddress);
