...
const struct NUInfo NetworkUpgradeInfo[Consensus::MAX_NETWORK_UPGRADES] = {
    {
        /*.nBranchId =*/ 0,
        /*.strName =*/ "Base",
        /*.strInfo =*/ "The Bitcoinlove network at launch",
    },
    {
    ...
    },
     {
        ...
        /*.strName =*/ "LWMA",
        /*.strInfo =*/ "Bitcoinlove upgraded to LWMA difficulty algorithm",
    },
     {
        /*.nBranchId =*/ 0x76b809bb,
        /*.strName =*/ "Equihash 144/5",
        /*.strInfo =*/ "Bitcoinlove PoW Change to Equihash 144/5",
    },	
    {
        /*.nBranchId =*/ 0x76b809bb,
        /*.strName =*/ "Acadia",
        /*.strInfo =*/ "The Bitcoinlove Acadia Update",
    },
    {
        /*.nBranchId =*/ 0x76b809bb,
        /*.strName =*/ "Kamiooka",
