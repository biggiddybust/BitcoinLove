/*
See the Bitcoinlove protocol specification for more information.
https://github.com/bitcoinlove/zips/blob/master/protocol/protocol.pdf
*/
...
typedef libbitcoinlove::NoteEncryption<ZC_NOTEPLAINTEXT_SIZE> ZCNoteEncryption;
typedef libbitcoinlove::NoteDecryption<ZC_NOTEPLAINTEXT_SIZE> ZCNoteDecryption;

typedef libbitcoinlove::PaymentDisclosureNoteDecryption<ZC_NOTEPLAINTEXT_SIZE> ZCPaymentDisclosureNoteDecryption;
