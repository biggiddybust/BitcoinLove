...
#include "Bitcoinlove.h"
#include "bitcoinlove/util.h"

namespace libbitcoinlove {
...
} // end namespace `libbitcoinlove`


typedef libbitcoinlove::IncrementalMerkleTree<INCREMENTAL_MERKLE_TREE_DEPTH, libbitcoinlove::SHA256Compress> SproutMerkleTree;
typedef libbitcoinlove::IncrementalMerkleTree<INCREMENTAL_MERKLE_TREE_DEPTH_TESTING, libbitcoinlove::SHA256Compress> SproutTestingMerkleTree;

typedef libbitcoinlove::IncrementalWitness<INCREMENTAL_MERKLE_TREE_DEPTH, libbitcoinlove::SHA256Compress> SproutWitness;
typedef libbitcoinlove::IncrementalWitness<INCREMENTAL_MERKLE_TREE_DEPTH_TESTING, libbitcoinlove::SHA256Compress> SproutTestingWitness;

typedef libbitcoinlove::IncrementalMerkleTree<SAPLING_INCREMENTAL_MERKLE_TREE_DEPTH, libbitcoinlove::PedersenHash> SaplingMerkleTree;
typedef libbitcoinlove::IncrementalMerkleTree<INCREMENTAL_MERKLE_TREE_DEPTH_TESTING, libbitcoinlove::PedersenHash> SaplingTestingMerkleTree;

typedef libbitcoinlove::IncrementalWitness<SAPLING_INCREMENTAL_MERKLE_TREE_DEPTH, libbitcoinlove::PedersenHash> SaplingWitness;
typedef libbitcoinlove::IncrementalWitness<INCREMENTAL_MERKLE_TREE_DEPTH_TESTING, libbitcoinlove::PedersenHash> SaplingTestingWitness;
