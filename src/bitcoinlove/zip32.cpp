...
boost::optional<std::pair<diversifier_index_t, libbitcoinlove::SaplingPaymentAddress>>
    SaplingExtendedFullViewingKey::Address(diversifier_index_t j) const
{
    ...
    CSerializeData addr_bytes(libbitcoinlove::SerializedSaplingPaymentAddressSize);
...
libbitcoinlove::SaplingPaymentAddress SaplingExtendedFullViewingKey::DefaultAddress() const
{
...
libbitcoinlove::SaplingPaymentAddress SaplingExtendedSpendingKey::DefaultAddress() const
{
...
bool IsValidSpendingKey(const libbitcoinlove::SpendingKey& zkey) {
    return zkey.which() != 0;
}
