...
# contains all of the packages required to build this version of Bitcoinlove.
#
# This script assumes you've just built Bitcoinlove, and that as a result of that
