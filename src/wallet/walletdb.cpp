...
bool CWalletDB::WriteCryptedZKey(const libbitcoinlove::SproutPaymentAddress & addr,
...
bool CWalletDB::WriteZKey(const libbitcoinlove::SproutPaymentAddress& addr, const libbitcoinlove::SproutSpendingKey& key, const CKeyMetadata &keyMeta)
{
    nWalletDBUpdated++;
...
bool CWalletDB::WriteSaplingZKey(const libbitcoinlove::SaplingIncomingViewingKey &ivk,
...
bool CWalletDB::WriteSproutViewingKey(const libbitcoinlove::SproutViewingKey &vk)
{
    nWalletDBUpdated++;
    return Write(std::make_pair(std::string("vkey"), vk), '1');
}

bool CWalletDB::EraseSproutViewingKey(const libbitcoinlove::SproutViewingKey &vk)
{
    nWalletDBUpdated++;
             ...
             CWalletScanState &wss, string& strType, string& strErr)
{
    try {
        ...
        {
            libbitcoinlove::SproutViewingKey vk;
            ssKey >> vk;
            char fYes;
            ssValue >> fYes;
            if (fYes == '1')
        ...
        {
            libbitcoinlove::SproutPaymentAddress addr;
            ssKey >> addr;
        ...
        else if (strType == "sapzkey")
        {
            ...
            ssKey >> ivk;
            libbitcoinlove::SaplingExtendedSpendingKey key;
            ssValue >> key;
        ...
        else if (strType == "czkey")
        {
            ...
            uint256 rkValue;
            ssValue >> rkValue;
            libbitcoinlove::ReceivingKey rk(rkValue);
        ...
        else if (strType == "csapzkey")
        {
            libbitcoinlove::SaplingIncomingViewingKey ivk;
            ssKey >> ivk;
            libbitcoinlove::SaplingExtendedFullViewingKey extfvk;
            ssValue >> extfvk;
            vector<unsigned char> vchCryptedSecret;
            ssValue >> vchCryptedSecret;
            wss.nCKeys++;
        ...
        {
            libbitcoinlove::SaplingPaymentAddress addr;
            ssKey >> addr;
            libbitcoinlove::SaplingIncomingViewingKey ivk;
            ssValue >> ivk;
